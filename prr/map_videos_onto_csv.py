...
def main(input_folder, output_csv, match_string=None):
    ...
    for path in tqdm(df['filepath']):
        ...
        date_string = base_name[-15:-7]
        time_string = base_name[-6:]
...
if __name__ == "__main__":
    ...
    output_csv = 'cyclesix_empty.csv'
    match_string = 'cyclesix_screen'  # Change this to None if you don't want to filter by string

    main(input_folder, output_csv, match_string)
